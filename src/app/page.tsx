...
export default function Home() {
  const [requestMessage, setRequesteMessage] = useState('');
    ...
    <main className='relative h-full w-full transition-width flex flex-col overflow-hidden items-stretch flex-1'>
      ...
      <div className='absolute bottom-0 left-0 w-full border-t md:border-t-0 dark:border-white/20 md:border-transparent md:dark:border-transparent md:bg-vert-light-gradient bg-white dark:bg-gray-800 md:!bg-transparent dark:md:bg-vert-dark-gradient pt-2'>
              ...
              <div className='flex ml-1 md:w-full md:m-auto md:mb-2 gap-0 md:gap-2 justify-center'>
                <div className='flex flex-col w-full py-2 flex-grow md:py-3 md:pl-4 relative border border-black/10 bg-white dark:border-gray-900/50 dark:text-white dark:bg-gray-700 rounded-md shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]'>
                  <input
                    ...
                    onChange={(e) => setRequesteMessage(e.target.value)}
                  />
        ...
        <div className='px-3 pt-2 pb-3 text-center text-xs text-black/50 dark:text-white/50 md:px-4 md:pt-3 md:pb-6'>
          ...
          . Free Research Preview. Our goal is to make AI systems more natural and safe to interact with.
